  ...
  return (
      ...
      <div id="__nuxt" data-v-app="">
        <div class="fixed flex pl-2 pr-3 py-1 flex-col-reverse bottom-[80px] z-20 right-0">
          <div data-v-cd88ab75="" class="blurWrapper">
            <div
              data-v-d320b445=""
              data-v-cd88ab75=""
              class="w-full gradient-border borderWrapper"
            >
              <div
                data-v-cd88ab75=""
              ...
              >
                <span data-v-cd88ab75="" class="nuxt-icon my-1 text-[19px]">
                  <svg
                    width="20"
                    height="20"
                    viewBox="0 0 20 20"
                ...
                <p data-v-cd88ab75="" class="text-[10px] text-center">
                  ติดต่อ
                </p>
              </div>
            </div>
                        ...
                        >
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704335445.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/PC_Huaydragon.b79f7f78.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/Happy_Fishing.66cf837a.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/PC_Slot%20Roma.b0caa4e0.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/Hall_of_God.31d96cff.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./asstes/home_files/Hilo_Island.5f5d991a.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="home_files/1711337946232.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1708944100058.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252696243.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1705331482504.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252580904.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1699347090991.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1699347168724.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="/home_files/1699347120315.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252532418.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252505985.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252545648.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1706252553976.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1692872953868.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1699347056905.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711620750488.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711624469914.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704185165.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704208977.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                            ...
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  ...
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                                />
                                <div class="absolute flex flex-col z-10 space-y-1 w-auto min-w-[30px] h-[16px] text-center text-[10px] top-2 left-2">
                                  \
                                </div>
                              </div>
                            </div>
                        ...
                        >
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1692872972710.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711620779678.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711624418759.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704482048.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704490058.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/1711704496098.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/mb1.a020cd91.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/mb2.237131b8.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
                          ...
                          >
                            <div class="">
                              <div class="h-[63px] w-full md:h-[167px] relative cursor-pointer">
                                <img
                                  src="./assets/home_files/mb3.8bdae25a.png"
                                  alt="img-cover"
                                  loading="lazy"
                                  draggable="false"
                                  class="rounded-base object-cover z-[9] h-full w-full relative"
        ...
        <footer data-v-3c88d514="" class="mx-auto bg-[transparent] fixed bottom-[-2px] footer h-[80px] w-full flex">
          ...
          <div class="navigate-wrapper">
            <div></div>
            <div class="navigate-container md:max-w-[630px] base-container-small"><a aria-current="page"
                href="https://lucabet88.electrikora.com/home/providers"
                ...
                <div><span class="nuxt-icon text-[var(--primary)] text-[23px]"><svg width="24" height="24"
                  ...
                  <span class="text-[12px] gradientText text-[var(--primary)]">หน้าหลัก</span></div>
              </a>
    ...
    {/* <div class="modal-overlay hidden">
      <div class="modal relative"><span
        ...
        </span><iframe class="h-full w-full bg-white" src=".assets/home_files/widget.htm"></iframe></div>
    </div> */}
  </div>
    </body>
  );
