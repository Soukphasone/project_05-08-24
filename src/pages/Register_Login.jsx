        ...
        <div id="__nuxt" data-v-app="">
          ...
          <div data-v-19df7d63="">
            ...
            <main data-v-19df7d63="" class="min-h-screen">
              <div data-v-19df7d63="" class="w-full mx-auto">
                ...
                <main
                  data-v-d8556cff=""
                  class="bg-login-wrapper bg-login-wrapper"
                >
                  <div
                    data-v-d8556cff=""
                    ...
                    >
                      <div data-v-d8556cff="" class="mt-0">
                        <div data-v-d8556cff="" class="">
                              ...
                              >
                                ...
                                >
                                  ...
                                  <div
                                    data-v-ea58f736=""
                                    id="auth-advance-tab"
                                    class="tabslinks relative cursor-pointer flex items-center justify-center login w-full active"
                                  >
                                    <span
                                      data-v-ea58f736=""
                                  ...
                                  <div
                                    data-v-ea58f736=""
                                    id="auth-advance-tab"
                                    class="tabslinks relative cursor-pointer flex items-center justify-center btn-register w-full"
                                  >
                                    <span
                                      data-v-ea58f736=""
                                      class="font-normal &lt;sm:text-base sm:text-base md:text-lg"
                              ...
                              >
                                ...
                                >
                                  ...
                                  >
                                    <div
                                      data-v-b23e53de=""
                                      class="bg-transparent border-1 rounded-full border-gray-400 w-4 h-4 flex flex-shrink-0 justify-center items-center mr-2"
                                    >
                                      <input
                                        data-v-b23e53de=""
                                        type="checkbox"
                                      ...
                                      <svg
                                        data-v-b23e53de=""
                                        class="fill-current hidden w-2 h-2 text-active pointer-events-none"
                                        viewBox="0 0 20 20"
                                      >
                                        <path
                                          data-v-b23e53de=""
                                    ...
                                    <div data-v-b23e53de="" class="text-xs">
                                      จดจำฉัน
                                    </div>
                                  </label>
                                  <p
                                    data-v-d8556cff=""
                                    class="cursor-pointer underline text-primary text-xs"
                                  >
                                    ลืมรหัสผ่าน
                                  </p>
                                </div>
                          ...
                          >
                            <div data-v-704c3ab0="" data-v-d8556cff="" class="">
                              <div
                                data-v-704c3ab0=""
          ...
          <div class="modal-overlay hidden">
            <div class="modal relative">
              <span class="nuxt-icon nuxt-icon--fill absolute bg-[red] top-[-10px] right-[-10px] text-sm p-2 rounded-full z-10 text-xs cursor-pointer">
                <svg
                  width="100"
                  height="100"
                  viewBox="0 0 100 100"
              ...
              <iframe
                ...
                src="lucabet88%20-%20%E0%B9%80%E0%B8%82%E0%B9%89%E0%B8%B2%E0%B8%AA%E0%B8%B9%E0%B9%88%E0%B8%A3%E0%B8%B0%E0%B8%9A%E0%B8%9A_files/widget.htm"
              ></iframe>
            </div>
          </div>
        </div>
