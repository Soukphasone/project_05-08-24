...
function Profile() {
  ...
  <div id="__nuxt" data-v-app="">
            ...
            <div data-v-4b602944="" class="w-full mx-auto base-container flex items-center justify-between">
              <div data-v-4b602944="" class="flex space-x-4 items-center justify-center w-full &lt;sm:justify-around">
                <img data-v-4b602944="" class="cursor-pointer object-contain h-auto max-h-[80px] max-w-[120px]"
                  src="profile_files/1674807129586.png" alt="center menu"/>
            ...
            <div class="p-4 rounded-base space-y-4 bg-[var(--card-primary)]">
              <div data-v-ea58f736="" id="profileTab" class="w-full">
                <div data-v-ea58f736="" class="tabsWrapper w-full">
                  <div data-v-ea58f736="" class="tabs relative flex items-center justify-center tab-secondary w-full">
                    <div data-v-ea58f736="" class="w-full absolute bottom-0 left-0 rounded-full slide profileTab"
                      style={{width: '194px', left: '0px'}}></div>
                    <div data-v-ea58f736=""
                      class="w-full absolute bottom-0 left-0 rounded-full slide-border profileTab"></div>
                    <div data-v-ea58f736="" id="profileTab"
                      class="tabslinks relative cursor-pointer flex items-center justify-center userInfo w-full active">
                      <span data-v-ea58f736=""
                        class="font-normal &lt;sm:text-base sm:text-base md:text-lg">ข้อมูลส่วนตัว</span></div>
                    <div data-v-ea58f736="" id="profileTab"
                      class="tabslinks relative cursor-pointer flex items-center justify-center bankInfo w-full">
                      <span data-v-ea58f736=""
                        class="font-normal &lt;sm:text-base sm:text-base md:text-lg">บัญชีธนาคาร</span></div>
                  </div>
                </div>
              </div>
              <div class="space-y-[10px]">
                <div class="w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">ยูสเซอร์เข้าเกม</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">bet88379365048</span><span
                      class="nuxt-icon nuxt-icon--fill cursor-pointer text-[var(--primary)]"><svg width="16" height="16"
                ...
                <div class="w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">รหัสเข้าเกม</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">Sm2708</span><span
                      class="nuxt-icon nuxt-icon--fill cursor-pointer text-active"><svg width="16" height="16"
                        viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    </span><span class="nuxt-icon nuxt-icon--fill cursor-pointer text-[var(--primary)]"><svg width="16"
                ...
                <div class="w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">รหัส PIN</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">1111</span><span
                      class="nuxt-icon nuxt-icon--fill cursor-pointer text-active"><svg width="16" height="16"
                        viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_4810_15761)">
                          <path
                ...
                <div class="w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">LINE</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">-</span></div>
                </div>
                <div class="w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">วันเกิด</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">ยังไม่ได้ลงทะเบียน</span>
                  </div>
                </div>
              </div>
            </div>
            <div class="p-4 mt-4 rounded-[18px] bg-primaryCard bg-card-primary"><span
                class="text-active text-base font-medium">ชวนเพื่อนรับโบนัส <div
                  class="mt-[10px] w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">รหัสชวนเพื่อน</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">8zejRe3U7A</span><span
                      class="nuxt-icon nuxt-icon--fill cursor-pointer text-[var(--primary)]"><svg width="16" height="16"
                        viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_268_1612)">
                          <path
                ...
                <div class="mt-[10px] w-full flex bg-[var(--card-secondary)] px-4 py-[11px] rounded-[10px]"><span
                    class="text-sm text-left w-[60%] text-[var(--text-link)]">ลิงก์ชวนเพื่อน</span>
                  <div class="w-full flex items-center gap-x-4 justify-between"><span
                      class="text-primary text-left w-full max-w-40 truncate text-sm">https://lucabet88.electrikora.com/?prefix=lucabet88&amp;action=register&amp;refer_code=8zejRe3U7A</span><span
                      class="nuxt-icon nuxt-icon--fill cursor-pointer text-[var(--primary)]"><svg width="16" height="16"
                        viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_268_1612)">
                          <path
                ...
                </div><button data-v-9dec3a92="" id="btn01" type="submit"
                  class="base-button-wrapper v-rounded btn-primary btn-md mt-[10px] btn-primary w-full">
                  <div data-v-9dec3a92="" class="flex justify-center items-center">แชร์รับรายได้</div>
                </button>
              </span></div>
          </div>
        ...
        <footer data-v-3c88d514="" class="mx-auto bg-[transparent] fixed bottom-[-2px] footer h-[80px] w-full flex">
          ...
          <div class="navigate-wrapper">
            ...
            <div class="navigate-container md:max-w-[630px] base-container-small"><a
                href="https://lucabet88.electrikora.com/home/providers" class="item md:w-full">
                <div><span class="nuxt-icon text-[23px]"><svg width="100" height="100" viewBox="0 0 100 100" fill="none"
                      xmlns="http://www.w3.org/2000/svg">
                      <path
                  ...
                  </span><span class="text-[12px]">หน้าหลัก</span></div>
              </a>
    ...
    <div class="modal-overlay hidden">
      <div class="modal relative"><span
          class="nuxt-icon nuxt-icon--fill absolute bg-[red] top-[-10px] right-[-10px] text-sm p-2 rounded-full z-10 text-xs cursor-pointer"><svg
        ...
        </span><iframe class="h-full w-full bg-white" src="profile_files/widget.htm"></iframe></div>
    </div>
  </div>
</body>
